...
public interface StrategyHolder {
     ...
     *
     * @return A readonly Map of the currently mapped classes and their StrategyBurnable.
     */
    Map<Class, GarbageDisposalStrategy>getDisposalStrategies ();

    /**
     * A method for adding a new Annotation class and corresponding strategy to the currently contained disposal StrategyBurnable. annotationClass
